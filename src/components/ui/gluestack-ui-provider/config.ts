...
export const config = {
  ...
  dark: vars({
    ...
    "--color-green-500": colors.green_500,
    "--color-green-600": colors.green_600,
    "--color-green-700": colors.green_700,
